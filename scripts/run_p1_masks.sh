...
RUN_NAME="${RUN_NAME:-p1_masks_20260916}"
[[ ! -e "artifacts/logs/${RUN_NAME}.status" ]] || { echo 'Choose a fresh RUN_NAME'; exit 2; }
...
"$PYTHON" blt_hf_checks/check_attention_mask.py --output "blt_hf_checks/results/${RUN_NAME}.json"
