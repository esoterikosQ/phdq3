...
"$PYTHON" -m unittest discover -s tests -p test_hf_generation.py -v
for backend in eager sdpa; do
  "$PYTHON" blt_hf_checks/check_load_generate.py --model-path artifacts/converted/blt-1b-hf-own \
